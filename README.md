...
Consultas de DNI y RUC sin uso de captcha ni OCR.

# Install
Using composer from [packagist.org](https://packagist.org/packages/giansalex/peru-consult)
```bash
...
- Dni require extensions `gd` and `openssl`.
